...
def event_scrape(source_id: Optional[str] = None, quarantine_new: bool = False) -> str:
    ...
    Available source_ids: beatrice-calendar, sensualeros-boston, unabulla-cuban-boston, lister-events, eventbrite-boston-latin, fiesta-dance-company, somerville-arts, submissions
